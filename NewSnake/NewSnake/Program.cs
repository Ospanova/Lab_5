    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Menu:;
                ...
                Console.Clear();//
                Console.WriteLine("Press 1 to start a new game");//новая игра
                Console.WriteLine("Press 2 to continue last game");//продолжить новую игру
                Console.WriteLine("Press 3 to exit");//выход
            ...
            next_level:;//метка (корректный идентификатор)
                ...
                if (Gameover)
                {
                    //score = 0;
                    Console.Clear();
                    Console.WriteLine("You lost! Press any key to go to menu.");
